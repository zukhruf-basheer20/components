...
export default function Card1() {
  return (
    <div className="max-w-sm w-full mx-auto p-8 rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.70)] bg-gray-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group">
      <div className="h-[15rem] md:h-[20rem] rounded-xl z-40 bg-neutral-300 dark:bg-[rgba(40,40,40,0.70)] [mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]">
        <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
          <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
            ...
            <div
              id="style-pvfli"
              className="rounded-full flex items-center justify-center bg-[rgba(248,248,248,0.01)] shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)] h-12 w-12 circle-2 style-pvfli"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="1em"
            ...
            <div
              id="style-co8vS"
              className="h-16 w-16 rounded-full flex items-center justify-center bg-[rgba(248,248,248,0.01)] shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)] circle-3 style-co8vS"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <div className="h-40 w-px absolute top-20 m-auto z-40 bg-gradient-to-b from-transparent via-cyan-500 to-transparent animate-move">
            <div className="w-10 h-32 top-1/2 -translate-y-1/2 absolute -left-10">
              <div className="absolute inset-0">
                <span
                  id="style-85zWm"
                  className="inline-block bg-black dark:bg-white style-85zWm"
                ></span>
                <span
                  id="style-LbmUy"
                  className="inline-block bg-black dark:bg-white style-LbmUy"
                ></span>
                <span
                  id="style-OTex5"
                  className="inline-block bg-black dark:bg-white style-OTex5"
                ></span>
                <span
                  id="style-oUEf7"
                  className="inline-block bg-black dark:bg-white style-oUEf7"
                ></span>
                <span
                  id="style-9lwEF"
                  className="inline-block bg-black dark:bg-white style-9lwEF"
                ></span>
                <span
                  id="style-VSPhh"
                  className="inline-block bg-black dark:bg-white style-VSPhh"
                ></span>
                <span
                  id="style-YKMZp"
                  className="inline-block bg-black dark:bg-white style-YKMZp"
                ></span>
                <span
                  id="style-D4K7j"
                  className="inline-block bg-black dark:bg-white style-D4K7j"
                ></span>
                <span
                  id="style-61SdM"
                  className="inline-block bg-black dark:bg-white style-61SdM"
                ></span>
                <span
                  id="style-xcj7O"
                  className="inline-block bg-black dark:bg-white style-xcj7O"
                ></span>
                <span
                  id="style-P6qK5"
                  className="inline-block bg-black dark:bg-white style-P6qK5"
                ></span>
                <span
                  id="style-XRDvo"
                  className="inline-block bg-black dark:bg-white style-XRDvo"
                ></span>
              </div>
            </div>
          </div>
