...
function App() {
  return (
    <div className="app flex flex-col gap-y-4 relative justify-center">
      <div className="flex space-x-4 w-auto h-auto text-black bg-blue-500 relative justify-center">
        <h1 className="text-4xl">
          All combination of buttons with styling and animation effects
        </h1>
      </div>
      ...
      <div className="flex space-x-4 p-4 w-auto h-auto">
        <Button31 />
        <Button32 />
        <Button33 />
        <Button34 />
      ...
      <div className="flex space-x-4 w-auto h-auto text-black bg-blue-500 relative justify-center">
        <h1 className="text-4xl">
          All combination of cards with styling and animation effects
        </h1>
      </div>
      <div className=" flex p-10 space-x-4 w-auto h-auto relative justify-center">
        <Card1 />
      </div>
      <div className="flex p-4 space-x-4 w-auto h-auto relative justify-center">
        <Card2 />
        <Card3 />
        <Card4 />
        <Card7 />
      </div>
      <div className="flex p-4 space-x-7 w-auto h-auto relative justify-center">
        <Card5 />
        <Card6 />
      </div>
      <div className="flex p-4 space-x-7 w-auto h-auto relative justify-center">
